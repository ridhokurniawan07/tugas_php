            ...
            <div class="col-md-6">
                ...
                <form action="../proses/proses_tambahbuku.php" method="post">
                    <table class="table">
                        <tr>
                            <td>ISBN</td>
                            <td><input type="text" name="isbn" class="form-control" required="" id="isbn"></td>
                        </tr>
                        <tr>
                            <td>Judul</td>
                            <td><input type="text" name="judul" class="form-control" required="" id="judul"></td>
                        </tr>
                        <tr>
                            <td>Tahun</td>
                            <td><input type="text" name="tahun" class="form-control" required="" id="tahun"></td>
                        </tr>
                        <tr>
                            <td>Id Penerbit</td>
                            <td>
                        ...
                        <tr>
                            <td>Stok</td>
                            <td><input type="text" name="qty_stok" class="form-control" required="" id="stok"></td>
                        </tr>
                        <tr>
                            <td>Harga Pinjam</td>
                            <td><input type="text" name="harga_pinjam" class="form-control" required="" id="harga"></td>
                        </tr>
                        <tr>
                            <td></td>
