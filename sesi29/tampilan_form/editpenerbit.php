            ...
            <div class="col-md-6">
                ...
                <form action="../proses/proses_editpenerbit.php?id=<?php echo $id ?>" method="post">
                    <table class="table">
                        <tr>
                            <td>ID Penerbit</td>
                            <td><input type="text" name="id_penerbit" class="form-control" required="" value="<?php echo $id ?>" id="idpenerbit"></td>
                        </tr>
                        <tr>
                            <td>Nama</td>
                            <td><input type="text" name="nama_penerbit" class="form-control" required="" value="<?php echo $nama ?>" id="nama"></td>
                        </tr>
                        <tr>
                            <td>email</td>
