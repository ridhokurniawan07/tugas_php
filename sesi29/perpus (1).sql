...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Nov 2023 pada 09.01
...
(1, 'Administrator', 'adminn', 'admin', 'P', '0891281111', 'Bandung', 'admin@gmail.com', '2023-11-05 07:54:58', 'ADMIN'),
...
(8, 'Najmin', 'najmin', 'najmin', 'L', '08712911991', 'Sukaraja, Bandung', 'najmina@gmail.com', '2023-11-05 06:49:48', 'ADMIN'),
...
(21, 'ridho', 'ridho7', '123', 'L', '123', 'a', 'a@gmail.com', '2023-11-05 07:54:22', 'USER');
...
('1234', '1234', 1234, 'PN01', 'PG01', 'KG0', 123, 123),
('1235', '1235', 1235, 'PN03', 'PG03', 'KG3', 1235, 1235),
...
('PN01', 'Penerbit 011', 'penerbit@perpus.co.ids', '02199993331', 'Surabayaaa'),
('PN02', 'Penerbit 02', 'penerbit2@gmail.com', '08765158111', 'Bandung'),
('PN03', 'Penerbit 03', 'penerbit3@gmail.com', '1234', 'Jakarta Barat'),
('PN031', 'Penerbit ', 'a@gmail.com', '123', 'w'),
('PN05', 'pn51', 'pn5@gmail.com', '12345678', 'bekasii');
...
--
ALTER TABLE `buku`
  ADD CONSTRAINT `katalog` FOREIGN KEY (`id_katalog`) REFERENCES `katalog` (`id_katalog`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `penerbit` FOREIGN KEY (`id_penerbit`) REFERENCES `penerbit` (`id_penerbit`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pengarang` FOREIGN KEY (`id_pengarang`) REFERENCES `pengarang` (`id_pengarang`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `detail_peminjaman`
--
ALTER TABLE `detail_peminjaman`
  ADD CONSTRAINT `id_pinjam` FOREIGN KEY (`id_pinjam`) REFERENCES `peminjaman` (`id_pinjam`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `isbn` FOREIGN KEY (`isbn`) REFERENCES `buku` (`isbn`) ON DELETE CASCADE ON UPDATE CASCADE;
